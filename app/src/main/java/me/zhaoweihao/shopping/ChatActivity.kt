...
import me.zhaoweihao.shopping.gson.Message
import me.zhaoweihao.shopping.gson.Send
                ...
                HttpUtil.sendOkHttpPostRequest(url, jsonObject, object : Callback {
                    ...
                    override fun onResponse(call: Call?, response: Response?) {
                        ...
                        if (getLog!!.code == 200) {
                            ...
                            send.from = "/user/" + data.logFrom
                            send.to = "/user/" + data.logTo
                            send.data = Gson().toJson(data)
